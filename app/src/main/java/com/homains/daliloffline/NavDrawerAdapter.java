...
public class NavDrawerAdapter extends
	...
	public NavDrawerAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup,
			int i) {
		if (i == 0) {
	        return new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(com.homains.daliloffline.R.layout.drawer_top, viewGroup, false));
	    } else if (i == 1) {
	    	return new ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(com.homains.daliloffline.R.layout.drawer_section, viewGroup, false));
	    }
		
		View v = LayoutInflater.from(viewGroup.getContext()).inflate(
				com.homains.daliloffline.R.layout.drawer_row, viewGroup, false);
	...
	private void setBackgroundColor(int i,
		...
		if (mSelectedPosition == i || mTouchedPosition == i) {
			viewHolder.itemView.setBackgroundColor(viewHolder.itemView
					...
					.getColor(com.homains.daliloffline.R.color.selected_gray));
		} else {
	...
	public static class ViewHolder extends RecyclerView.ViewHolder {
		...
		public ViewHolder(View itemView) {
			super(itemView);
			textViewItem = (TextView) itemView.findViewById(com.homains.daliloffline.R.id.item_name);
			textViewExtra = (TextView) itemView.findViewById(com.homains.daliloffline.R.id.extra_name);
			textViewSection = (TextView) itemView
					.findViewById(com.homains.daliloffline.R.id.section_name);
		}
	}
}
