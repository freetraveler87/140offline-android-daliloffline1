...
public void onCreate(Bundle savedInstanceState) {
   ...
   addPreferencesFromResource(com.homains.daliloffline.R.xml.activity_settings);
   ...
   String push = getString(com.homains.daliloffline.R.string.rss_push_url);
   ...
   preferenceabout.setOnPreferenceClickListener(new OnPreferenceClickListener() {
       ...
       public boolean onPreferenceClick(Preference preference) {
    	   ...
    	   ab.setMessage( Html.fromHtml(getResources().getString(com.homains.daliloffline.R.string.about_text)));
    	   ab.setPositiveButton(getResources().getString(com.homains.daliloffline.R.string.ok), null);
    	   ab.setTitle(getResources().getString(com.homains.daliloffline.R.string.about_header));
    	   ab.show();
		return true;
       }
   });
