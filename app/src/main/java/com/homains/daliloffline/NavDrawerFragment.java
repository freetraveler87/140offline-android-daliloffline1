...
public class NavDrawerFragment extends Fragment implements NavDrawerCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    	View view;
        view = inflater.inflate(com.homains.daliloffline.R.layout.drawer_fragment, container, false);

        mDrawerList = (RecyclerView) view.findViewById(com.homains.daliloffline.R.id.drawerList);
    ...
    public void setup(int fragmentId, DrawerLayout drawerLayout, Toolbar toolbar) {
        ...
        mActionBarDrawerToggle = new ActionBarDrawerToggle(getActivity(), mDrawerLayout, toolbar, com.homains.daliloffline.R.string.drawer_open, com.homains.daliloffline.R.string.drawer_close) {
            @Override
        ...
        boolean newDrawer = getResources().getBoolean(com.homains.daliloffline.R.bool.newdrawer);
