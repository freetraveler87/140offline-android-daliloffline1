...
public class Helper {
    ...
    public static void noConnection(final Context context, boolean calledFromFragment) {
    	...
    	if (isOnline(context, false, false)){
    		ab.setMessage(context.getResources().getString(com.homains.daliloffline.R.string.dialog_connection_description));
    	   	ab.setPositiveButton(context.getResources().getString(com.homains.daliloffline.R.string.ok), null);
    	   	ab.setTitle(context.getResources().getString(com.homains.daliloffline.R.string.dialog_connection_title));
    	} else {
    		ab.setMessage(context.getResources().getString(com.homains.daliloffline.R.string.dialog_internet_description));
     	   	ab.setPositiveButton(context.getResources().getString(com.homains.daliloffline.R.string.ok), null);
     	   	ab.setTitle(context.getResources().getString(com.homains.daliloffline.R.string.dialog_internet_title));
    	}
